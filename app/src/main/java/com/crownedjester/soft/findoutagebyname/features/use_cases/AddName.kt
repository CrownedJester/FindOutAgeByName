...
class AddName @Inject constructor(private val repository: FavoriteNameDBRepository) {

    suspend operator fun invoke(name: FavoriteName) = repository.addFavoriteName(name)
}